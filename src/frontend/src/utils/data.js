...
export const Skills  = [
'HTML','CSS','Angular','React', 'ReactNative', 'Javascript/Typescript', 'Nodejs', 'Nextjs','Kotlin','Rust','Docker','Kubernetes',
'Ethereum','ICP','Adobe', 'Photoshop','illustrator','Canva','Figma','Sketch', 'Adobe XD','inVision','After Effects','Blender','Maya','ZBrush',
'SEO writing','Google Analytics', 'link', 'building','HubSpot','Google Ads','Email management','Asana','Trello','Jira'
]
